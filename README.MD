...
[ ![Download](https://api.bintray.com/packages/alphamu/customwidgets/PinEntryEditText/images/download.svg?version=1.3.10) ](https://bintray.com/alphamu/customwidgets/PinEntryEditText/1.3.10/link)
...
<com.alimuzaffar.lib.pin.PinEntryEditText
    ...
    android:layoutDirection="rtl|ltr"
    />
```
