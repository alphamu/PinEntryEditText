...
**Jetpack** support in version 2.0 [![Download](https://api.bintray.com/packages/alphamu/customwidgets/PinEntryEditText/images/download.svg)](https://bintray.com/alphamu/customwidgets/PinEntryEditText/_latestVersion):
    ...
    dependencies {
        implementation ('com.alimuzaffar.lib:pinentryedittext:2.0.4') {
...
If you don't use Jetpack, use version 1.3.X [ ![Download](https://api.bintray.com/packages/alphamu/customwidgets/PinEntryEditText/images/download.svg?version=1.3.8) ](https://bintray.com/alphamu/customwidgets/PinEntryEditText/1.3.6/link)
